"""Closed-world LIBERO processor recipe shared by M1 and online rollout."""
...
def load_m1_data_config(path: str | Path) -> tuple[dict[str, Any], str]:
    ...
    return extract_m1_libero_processor_recipe(value), digest
