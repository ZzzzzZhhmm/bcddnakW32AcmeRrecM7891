...
from fastwam.datasets.provenance import copy_provenance
    ...
    def preprocess(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Returns:
            Sample: Dict[str, Any], which can collated:
                ...
                - "idx": int, sample index
                - dataset/episode/frame provenance fields when present
        """
        sample = {}
        # 1. instruction
        ...
        sample["idx"] = data["idx"]
        # WARM candidate caches and long-memory retrieval must be able to
        # exclude the complete source episode.  Keep these values in their
        # original tensor form so the default DataLoader collator can batch
        # them without a custom collate function.
        copy_provenance(data, sample)
