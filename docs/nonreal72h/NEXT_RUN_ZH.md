...
**进度更新（2026-09-21）：下述50前缀任务已完成，50/50通过，作业实测610.33秒。W06 source诊断也已完成，但50个前缀均为自然g=0，没有激活覆盖。结果、备份和论文回填限制统一见 [实验记录](EXPERIMENT_RECORD_ZH.md)，剩余数据及执行顺序见 [下一步指令](NEXT_ACTIONS_ZH.md)。本文下方保留原启动计划与耗时预算，不代表当前仍在运行。**
